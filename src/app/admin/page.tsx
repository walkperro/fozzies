...
const CARDS = [
  ...
  { href: "/admin/faq", title: "FAQ Editor", note: "Edit FAQ page content persisted in site settings." },
  { href: "/admin/contact", title: "Contact Editor", note: "Edit Contact page content persisted in site settings." },
